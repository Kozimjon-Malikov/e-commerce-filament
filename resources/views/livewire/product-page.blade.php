        ...
        <div class="px-4 py-4 mx-auto max-w-7xl lg:py-6 md:px-6">
            <div class="flex flex-wrap mb-24 -mx-3">
                <div class="w-full pr-2 lg:w-1/4 lg:block">
                    ...
                    <div class="p-4 mb-5 bg-white border border-gray-200 dark:border-gray-900">
                        ...
                        <ul>
                            <li class="mb-4">
                                <label for="in_stock" class="flex items-center dark:text-gray-300">
                                    <input id="in_stock" type="checkbox" wire:model.live='in_stock'
                                        class="w-4 h-4 mr-2">
                    ...
                    <div class="p-4 mb-5 bg-white border border-gray-200  dark:border-gray-300">
                        <h2 class="text-2xl font-bold dark:text-gray-400">Price</h2>
                        <div class="w-16 pb-2 pt-4 mb-6 border-b border-rose-600 dark:border-gray-400">
                            {{ Number::currency($price_range, 'UZS') }}
                        </div>
                        <div>
                            ...
                            <div class="flex justify-between ">
                                <span
                                    class="inline-block text-lg font-bold text-blue-400 ">{{ Number::currency(1000, 'UZS') }}</span>
                                <span
                                    class="inline-block text-lg font-bold text-blue-400 ">{{ Number::currency(500000, 'UZS') }}</span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="px-3 mb-4">
                        <div class="items-center justify-between hidden px-3 py-2  md:flex  ">
                            <div class="flex items-center justify-between">
                                <select name="" wire:model.live='sort' id=""
                                    class="block w-40 text-base  cursor-pointer dark:text-gray-400">
                            ...
                            <div class="w-full px-3 mb-6 sm:w-1/2 md:w-1/3" wire:key='{{ $product->id }}'>
                                <div class="border border-gray-300 dark:border-gray-700">
                                    ...
                                    <div class="p-3 ">
                                        ...
                                        <p class="text-lg ">
                                            <span
                                                class="text-green-600 dark:text-green-600">{{ $product->price }}</span>
                                        </p>
                                    </div>
                                    <div class="flex justify-center p-4 border-t border-gray-300 dark:border-gray-700">

                                        <a href="#" wire:navigate wire:click.prevent='addToCart({{ $product->id }})'
