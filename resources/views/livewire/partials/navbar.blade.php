        ...
        <div class="relative md:flex md:items-center md:justify-between">
            <div class="flex items-center justify-between">
                <a class="flex-none text-xl font-semibold dark:text-white  " href="/"
                    aria-label="Brand">DCodeMania</a>
                <div class="md:hidden">
                    <button type="button"
                        class="hs-collapse-toggle flex justify-center items-center w-9 h-9 text-sm font-semibold rounded-lg border border-gray-200 text-gray-800 hover:bg-gray-100 disabled:opacity-50 disabled:pointer-events-none dark:text-white dark:border-gray-700 dark:hover:bg-gray-700  "
            ...
            <div id="navbar-collapse-with-animation"
                ...
                <div
                    ...
                    <div
                        ...
                        <a wire:navigate
                            class="{{ request()->is('/') ? 'text-blue-600' : 'text-gray-400' }} font-medium py-3 md:py-6   "
                            href="/" aria-current="page">Home</a>

                        <a wire:navigate
                            class="{{ request()->is('categories') ? 'text-blue-600' : 'text-gray-400' }} font-medium hover:text-gray-400 py-3 md:py-6 "
                            href="/categories">Categories</a>
                        <a wire:navigate
                            class="{{ request()->is('products') ? 'text-blue-600' : 'text-gray-400' }} font-medium hover:text-gray-400 py-3 md:py-6 "
                            href="/products">
                            Products
                        </a>

                        <a wire:navigate
                            class=" {{ request()->is('cart') ? 'text-blue-600' : 'text-gray-400' }} font-medium flex items-center  hover:text-gray-400 py-3 md:py-6 "
                            href="/cart">
                      ...
                      <div class="pt-3 md:pt-0">
                        <a class="py-2.5 px-4 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none  "
                            href="/login">
